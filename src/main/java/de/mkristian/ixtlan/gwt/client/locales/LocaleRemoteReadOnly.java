...
@Singleton
public class LocaleRemoteReadOnly extends ReadonlyRemoteAdapter<Locale> {

    private final LocalesRestService restService;
    
    @Inject
    protected LocaleRemoteReadOnly( NetworkIndicator networkIndicator, 
            EventBus eventBus, 
            LocalesRestService restService, 
            ReadonlyFactory<Locale, ?> factory ) {
