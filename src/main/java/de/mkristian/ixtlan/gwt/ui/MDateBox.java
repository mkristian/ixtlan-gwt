...
public class MDateBox extends MValueBoxBase<Date> {
    ...
    private static class DateValueBoxBase extends ValueBoxBase<Date> implements HasSource {
      ...
      private final MDateBox.DateRenderer dateRenderer;
      private final MDateBox.DateParser dateParser;
      private Object source;

      protected DateValueBoxBase(MDateBox.DateRenderer dateRenderer, MDateBox.DateParser dateParser) {
        super(DOM.createInputText(), dateRenderer, dateParser);
        this.dateRenderer = dateRenderer;
        this.dateParser = dateParser;
      }

      public MDateBox.DateParser getDateParser() {
        return dateParser;
      }

      public MDateBox.DateRenderer getDateRenderer() {
        return dateRenderer;
      }
    ...
    public static class DateRenderer implements Renderer<Date> {
      ...
      public String render(Date object) {
        return object == null ? null : format.format(object);
      }
    ...
    protected MDateBox.DateValueBoxBase getBox() {
      return (MDateBox.DateValueBoxBase) box;
    }
